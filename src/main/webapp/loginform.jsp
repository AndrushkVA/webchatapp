...
<div class="login">
    <form class="login-form" action="#" method="get">
        ...
        <input type="submit" id="login" formaction="/login" class="btn btn-primary fa-lg" value="Sign in" tabindex="3"/>
        <!-- <div class="login-bar">
    ...
    <div class="register">
        <div class="register-inner">
            <a href="registredform.jsp" class="btn btn-success">Create an Account</a>
        </div>
    </div>
</div>
